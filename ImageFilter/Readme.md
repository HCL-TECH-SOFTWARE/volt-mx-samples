...
- [createFilter](https://opensource.hcltechsw.com/volt-mx-docs/docs/documentation/Iris/iris_api_dev_guide/content/voltmxfilterconstants.html#voltmx.filter.createFilter)
